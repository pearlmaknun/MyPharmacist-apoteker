package io.pearlmaknun.mypharmacist_apoteker.helper;
...
public class GpsTrackers extends Service implements LocationListener {
                ...
                if (isNetworkEnabled) {
                    ...
                    if(locationManager != null){
                        ...
                        if (location != null) {
                            ...
                            Log.e("GPS Enabled", "GPS Enabled" + latitude + " " +longitude);
                        }
                    }
                }
